...
window.addEventListener("DOMContentLoaded", (event) => {
  ...
  curveChart(mdPuskesmasId, "PUSKESMAS_BULANAN", "SELECT * WHERE A = 'DAREK'");
  pieChart(
    mdPuskesmasId,
    "MASTER",
    "SELECT * WHERE A = 'DAREK' AND B > 0 AND C > 0"
  );
  tabelData(
    mdPuskesmasId,
    "MASTER",
    "SELECT F,G,H WHERE A = 'DAREK' AND G > 0 AND H > 0 ",
    [2, 3]
  );
