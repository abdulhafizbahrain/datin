...
window.addEventListener("DOMContentLoaded", (event) => {
  ...
  curveChart(mdPuskesmasId, "PUSKESMAS_BULANAN", "SELECT * WHERE A = 'AWANG'");
  pieChart(
    mdPuskesmasId,
    "MASTER",
    "SELECT * WHERE A = 'AWANG' AND B > 0 AND C > 0"
  );
  tabelData(
    mdPuskesmasId,
    "MASTER",
    "SELECT F,G,H WHERE A = 'AWANG' AND G > 0 AND H > 0 ",
    [2, 3]
  );
