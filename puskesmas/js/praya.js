...
window.addEventListener("DOMContentLoaded", (event) => {
  ...
  curveChart(mdPuskesmasId, "PUSKESMAS_BULANAN", "SELECT * WHERE A = 'PRAYA'");
  pieChart(
    mdPuskesmasId,
    "MASTER",
    "SELECT * WHERE A = 'PRAYA' AND B > 0 AND C > 0"
  );
  tabelData(
    mdPuskesmasId,
    "MASTER",
    "SELECT F,G,H WHERE A = 'PRAYA' AND G > 0 AND H > 0 ",
    [2, 3]
  );
