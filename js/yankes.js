...
window.addEventListener("DOMContentLoaded", (event) => {
  ...
  curveChart(mdBidangId, "BIDANG_BULANAN", "SELECT * WHERE A = 'YANKES'");
  pieChart(
    mdBidangId,
    "MASTER",
    "SELECT * WHERE A = 'YANKES' AND B > 0 AND C > 0"
  );
  tabelData(
    mdBidangId,
    "MASTER",
    "SELECT F,G,H WHERE A = 'YANKES' AND G > 0 AND H > 0 ",
    [2, 3]
  );
